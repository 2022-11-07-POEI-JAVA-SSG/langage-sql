...
-- VALUES('Galaxy S Mini','Samsung',199,1925),('Iphone 2','Apple',199,1925),('Lumia 8','Nokia',199,1925);
-- INSERT INTO telephones(name,manufacturer,price,units_sold)
-- VALUES
...
-- INSERT INTO telephones(name,manufacturer,price,units_sold)
-- VALUES('Galaxy S 300','M3i',199,1925);
...
-- Lister les 3 telephones qui ont réalisé les meilleurs chiffre d'affaire
-- SELECT name,(price*units_sold) AS ca FROM telephones ORDER BY ca DESC LIMIT 3;
...
-- SELECT manufacturer, SUM(price*units_sold) AS ca
--     FROM telephones
--     GROUP BY manufacturer
--     ORDER BY ca DESC;

-- Afficher uniquement les marques dont le ca est supérieur à 20000000
-- SELECT manufacturer, SUM(price*units_sold) AS ca
--     FROM telephones
--     GROUP BY manufacturer
...
--  values('Junit 5','Test runner pour le langage Java',19);
